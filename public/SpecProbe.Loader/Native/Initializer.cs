...
using SpecProbe.Loader.Native.Languages;
using SpecProbe.Software.Platform;

namespace SpecProbe.Loader.Native
{
    internal static class Initializer
    {
        ...
        internal static LibraryManager LibraryManager =>
            libManager ?? throw new Exception(LanguageTools.GetLocalized("SPECPROBE_LOADER_NATIVE_EXCEPTION_LIBMANAGERFAILED"));
            ...
            switch (platform)
            {
                case Platform.Windows:
                    libManager = bitness switch
                    {
                        ...
                        _ =>
                            throw new PlatformNotSupportedException(string.Format(LanguageTools.GetLocalized("SPECPROBE_LOADER_NATIVE_EXCEPTION_32BITUNSUPPORTED"), "https://officialaptivi.wordpress.com/2024/08/03/final-word-regarding-32-bit-support/")),
                    };
                    break;
