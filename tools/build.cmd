...
"%ProgramFiles%\dotnet\dotnet.exe" restore "..\SpecProbe.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
"%ProgramFiles%\dotnet\dotnet.exe" build "..\SpecProbe.sln" -p:Configuration=%releaseconfig% %buildoptions%
