...
"%ProgramFiles%\dotnet\dotnet.exe" restore "%ROOTDIR%\SpecProbe.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" build "%ROOTDIR%\SpecProbe.sln" -p:Configuration=%releaseconfig% %buildoptions%
